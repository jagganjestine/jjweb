...
The website was built using several third-party libraries, including React Router for routing, useState for mananging functional components, EmailJS for sending email, and Font Awesome for displaying icons. The website also utilizes CSS animations and transitions to make it more visually appealing.
