...
const Projects = () => {
      ...
      <div className="projects-container">
        <div className="project-card">
          ...
          <div className="card-body">
            ...
            <a href="https://github.com/jaj180010/cslinux" className="btn btn-github" target="_blank">View on GitHub</a>
          </div>
        </div>
        <div className="project-card">
  <img src={myPhoto} alt="Git" className="card-img-top" />
  <div className="card-body">
    ...
    <a href="https://github.com/jagganjestine/simple-calendar" className="btn btn-github" target="_blank">View on GitHub</a>
  </div>
</div>
        ...
        <img src={myPhoto} alt="Git" className="card-img-top" />
          <div className="card-body text-center">
            ...
            <div className="language-dot"><span className="dot dot-java"></span><p>Java</p></div>
            <a href="https://github.com/jagganjestine/text-editor" className="btn btn-github" target="_blank"> View on GitHub</a>
          </div>
        </div>
        <div className="project-card">
        <img src={myPhoto} alt="Git" className="card-img-top" />
          <div className="card-body">
            ...
            <a href="https://github.com/jagganjestine/stock-predictor" className="btn btn-github" target="_blank">View on GitHub</a>
          </div>
        </div>
        <div className="project-card">
        <img src={myPhoto} alt="Git" className="card-img-top" />
          <div className="card-body">
            ...
            <div className="language-dot"><span className="dot"></span><p>C</p></div>
            <a href="https://github.com/jagganjestine/travel-planner" className="btn btn-github" target="_blank">View on GitHub</a>
          </div>
        </div>
        <div className="project-card">
        <img src={myPhoto} alt="Git" className="card-img-top" />
          <div className="card-body">
            ...
            <div className="language-dot"><span className="dot"></span><p>C</p></div>
            <a href="https://github.com/jagganjestine/language-learner" className="btn btn-github" target="_blank">View on GitHub</a>
          </div>
        </div>
